...
CLAUDE_CONFIG_KEY = 'native_claude_config'    # mykey.py 中 Claude 配置的变量名
OPENAI_CONFIG_KEY = 'native_claude_config'     # mykey.py 中 OpenAI 配置的变量名（未使用）
MODELSCOPE_API_KEY = 'ms-560780ba-28ae-4795-b31e-a2bb670cebe4'  # ModelScope token
DEFAULT_BACKEND = 'modelscope'               # 默认后端: modelscope（主/备 API 均不支持多模态）
# =================================================================
