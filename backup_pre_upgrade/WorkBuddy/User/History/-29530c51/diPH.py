...
def batch_analyze():
    ...
    print("报告已保存到桌面:")
    print("   - 完整报告: A股智能分析报告_" + timestamp + ".xlsx")
    print("   - 强势股: 强势股_" + timestamp + ".xlsx")
    print("\n统计分析:")
    print("   成功分析: " + str(success_count) + "只")
    print("   数据失败: " + str(error_count) + "只")
    print("   高增长股票(>60%且健康度>=7): " + str(high_growth_count) + "只")
