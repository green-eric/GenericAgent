...
# Also fix the key references below
scores_map = {'gross_margin': 'gross_margin', 'net_margin': 'net_margin', 'revenue_yoy': 'revenue_yoy', 'profit_yoy': 'profit_yoy', 'ocf_ratio': 'ocf_ratio'}
