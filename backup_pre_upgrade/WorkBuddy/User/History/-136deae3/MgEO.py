...
def generate_comprehensive_summary(industries, total_analysis, cap_categories, advice_distribution):
    ...
    for i, (industry, count) in enumerate(top_industries, 1):
        ...
        # 行业投资逻辑
        if industry == "银行":
            print("   投资逻辑: 经济复苏受益，估值修复空间大")
            print("   重点: 招商银行、浦发银行等龙头")
            print("   风险: 利率环境变化，资产质量担忧")
        elif industry == "房地产":
            print("   投资逻辑: 政策放松预期，关注龙头房企")
            print("   重点: 保利发展等优质地产股")
            print("   风险: 政策效果不及预期")
        elif industry == "医药生物":
            print("   投资逻辑: 防御性强，长期增长确定")
            print("   重点: 创新药企，医疗器械龙头")
            print("   风险: 医保控费压力")
        elif industry == "电子":
            print("   投资逻辑: 国产替代+创新周期，成长性强")
            print("   重点: 半导体、消费电子龙头")
            print("   风险: 技术迭代快速")
        elif industry == "机械设备":
            print("   投资逻辑: 制造业升级受益，高端装备需求增长")
            print("   重点: 三一重工、工程机械龙头")
            print("   风险: 下游需求波动")
        elif industry == "食品饮料":
            print("   投资逻辑: 消费升级，品牌护城河深")
            print("   重点: 白酒龙头，食品饮料品牌")
            print("   风险: 消费降级影响")
        elif industry == "公用事业":
            print("   投资逻辑: 稳定现金流，防御性强")
            print("   重点: 电力、水务等基础设施")
            print("   风险: 政策监管加强")
        elif industry == "汽车":
            print("   投资逻辑: 新能源转型，智能化趋势")
            print("   重点: 新能源汽车产业链")
            print("   风险: 竞争加剧")
        elif industry == "化工":
            print("   投资逻辑: 原材料价格波动，周期性明显")
            print("   重点: 细分领域龙头")
            print("   风险: 大宗商品价格波动")
        elif industry == "有色金属":
            print("   投资逻辑: 资源稀缺性，供需格局改善")
            print("   重点: 铜、铝等基本金属")
            print("   风险: 全球经济周期影响")
