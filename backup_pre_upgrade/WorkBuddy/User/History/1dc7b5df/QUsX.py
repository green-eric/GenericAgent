...
print("\n" + "=" * 60)
print("_extract_quarterly_block 边界测试")
print("=" * 60)
...
print("\n" + "=" * 60)
print("parse_quarterly_finance 边界测试")
print("=" * 60)
...
print("\n" + "=" * 60)
print("_extract_annual_block 边界测试")
print("=" * 60)
ab = _extract_annual_block(MOCK_MULTI)
check("年报段落含ROE", "ROE18.52" in ab)
check("年报段落不含Q1", "Q1" not not in ab or "Q1" not in ab)

# ===== percentile_rank =====
print("\n" + "=" * 60)
print("percentile_rank 边界测试")
print("=" * 60)
...
none = {m: None for m in CORE_METRICS}
r4, l4 = calc_completeness(none)
...
check("负ROE评分=0", s_neg["profit_score"] == 0.0)
...
check("fallback折扣0.95", s_fallback["total_score"] < s1["total_score"] or s_fallback["total_score"] > 0)
