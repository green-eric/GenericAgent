            ...
            if mock:
                ...
                try:
                    ...
                    res = {
                        ...
                        'fcf_yield': round(calc.fcf_yield, 4),
...
def save_to_excel(results: List[Dict], filename: str = None):
    ...
    COL_DIMENSIONS = {
        ...
        'net_profit_ttm': 'cashflow', 'ocf_ttm': 'cashflow', 'cash_flow_quality': 'cashflow',
        'de_ratio': 'leverage', 'current_ratio': 'leverage', 'asset_liability_ratio': 'leverage', 'leverage_risk': 'leverage',
        ...
        def fetch_one(symbol):
            ...
            try:
                ...
                if df is not None and not df.empty:
                    ...
                    with lock:
                        success += 1
                        print(f"\r[数据] {success}/{len(symbols)} 成功, {fail} 失败", end='', flush=True)
                else:
                    with lock:
                        fail += 1
            except Exception as e:
