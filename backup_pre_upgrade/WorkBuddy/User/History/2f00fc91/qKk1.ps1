...
$PythonExePath = "C:\Users\green\AppData\Local\Python\bin\python.exe"
$Action = New-ScheduledTaskAction -Execute $PythonExePath -Argument "`"$PythonScriptPath`"" -WorkingDirectory $WorkingDirectory
